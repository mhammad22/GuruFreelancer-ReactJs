    ...
    return (
      <div>
        <div>
          <nav className="Cheader">
            <div className="OContainer">
              <div className="HeaderRow">
                <div className="HeaderRowLogo">
                  <a className="LogoA">
                    <img className="LogoHeight" src={guru} alt=" "></img>
                  </a>
                </div>
                <div className="HeaderRowNavigation">
                  <a className="HeaderNavigation">Find Freelancers</a>
                  <a className="HeaderNavigation">Find Jobs</a>
                  <a className="HeaderNavigation">
                    About
                    <img className="Arrow" src={down} alt=" "></img>
                  </a>
                  <a className="HeaderNavigation">
                    Solutions
                    <img className="Arrow" src={down} alt=" "></img>
                ...
                <ul className="HeaderRowAccount">
                  <li>
                    <a className="TopNavPostJob">Post a Job</a>
                  </li>
                  <li className="HeaderNavigationItem">
                    <a className="HeaderIcon">
                      <img className="ImgSignup" src={signup} alt=" "></img>
                      <span>Sign Up</span>
                    </a>
                  </li>
                  <li className="HeaderNavigationItem">
                    <a className="HeaderIcon">
                      <img className="ImgSignup" src={login} alt=" "></img>
                      <span>Login</span>
                    </a>
                  </li>
                </ul>
          ...
          <div className="HeaderModuleWhole">
            <div className="container">
              <div className="ModuleHeader">
                <span>
                  <h1 className="ModuleText1">Find and Hire Freelancers</h1>
                  <h2 className="ModuleText2">
                    We found 1,826,239 Freelancers offering 4,491,002
